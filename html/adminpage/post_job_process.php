...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $education_background = mysqli_real_escape_string($conn, $_POST['education_background']);
    ...
    $sql = "INSERT INTO job_postings (admin_id, job_title, company_name, salary, education, job_type, job_description, selected_options, requirment, work_location, remarks, date_posted, vacant) 
            VALUES ('$admin_id', '$job_title', '$company', '$salary', '$education_background', '$jobtype', '$job_description', '$optionsString', '$requirment', '$location', '$remarks', '$date_posted', '$vacant')";
