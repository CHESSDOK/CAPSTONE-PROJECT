...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO job_postings (admin_id, job_title, salary, job_type, job_description, specialization, requirment, work_location, remarks, date_posted, vacant) 
            VALUES ('$admin_id', '$job_title', '$salary', '$jobtype', '$job_description', '$spe', '$requirment', '$location', '$remarks', '$date_posted', '$vacant')";
