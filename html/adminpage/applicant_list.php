                        ...
                        if (!empty($applicants)) {
                            foreach ($applicants as $row) {
                                ...
                                if ($status != 'accepted' && $status != 'interview') {
                                    echo "
                                    <a href='application_process.php?id= ". htmlspecialchars($row['user_id']). "'>Accept</a>
                                    <a href='application_rejection.php?id=" . htmlspecialchars($row['user_id']) ."&job_id=" . htmlspecialchars($row['job_posting_id']) ."'>Reject</a>
                                    ...
                                    data-job-id=" . htmlspecialchars($row["job_posting_id"]) . ">Interview</button>";
                                        ...
                                        echo " <a href='application_process.php?id= ". htmlspecialchars($row['user_id']). "'>Accept</a>
                                                <a href='application_rejection.php?id=" . htmlspecialchars($row['user_id']) ."&job_id=" . htmlspecialchars($row['job_posting_id']) ."'>Reject</a>";
                                }
