    ...
    <div class="container mt-4">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" id="passport" class="form-control" placeholder="Input Passport Number" required>
        </div>
        <div class="col-md-6 mb-3">
          <label for="passport_expiry" class="info">Expiry Date</label>
          <input type="date" id="passport_expiry" class="form-control" required>
        </div>
      </div>
